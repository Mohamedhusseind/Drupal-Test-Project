...
class __TwigTemplate_6d03df95953fc1040b5253f1d51676836e1c3b8366853c777900fc86ce2237c2 extends \Twig\Template
{
    private $source;
    private $macros = [];
      ...
      <td class=\"description expand priority-low\">
        <details class=\"js-form-wrapper form-wrapper\" id=\"";
          ...
          <div class=\"details-wrapper\">
            ...
            // line 51
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Machine name: <span dir=\"ltr\" class=\"module-machine-name table-filter-text-source\">@machine-name</span>", ["@machine-name" => twig_get_attribute($this->env, $this->source, $context["module"], "machine_name", [], "any", false, false, true, 51)]));
            echo "</div>
                ";
            // line 52
            ...
            // line 61
            echo "                ";
            if (twig_get_attribute($this->env, $this->source, $context["module"], "path", [], "any", false, false, true, 61)) {
                // line 62
                echo "                  <div class=\"admin-requirements module-path\">";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(t("Module path: @module-list", ["@module-list" => twig_get_attribute($this->env, $this->source, $context["module"], "path", [], "any", false, false, true, 62)]));
                echo "</div>
                ";
            }
            // line 64
            echo "              </div>
              ";
            // line 65
            if (twig_get_attribute($this->env, $this->source, $context["module"], "links", [], "any", false, false, true, 65)) {
                // line 66
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["link_type"]) {
                    // line 68
                    echo "                    ";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((($__internal_compile_0 = twig_get_attribute($this->env, $this->source, $context["module"], "links", [], "any", false, false, true, 68)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0[$context["link_type"]] ?? null) : null), 68, $this->source), "html", null, true);
                    echo "
                  ";
                }
...
";
    ...
    {
        return array (  197 => 78,  178 => 72,  174 => 70,  165 => 68,  161 => 67,  158 => 66,  156 => 65,  153 => 64,  147 => 62,  144 => 61,  138 => 59,  135 => 58,  129 => 56,  126 => 55,  120 => 53,  118 => 52,  114 => 51,  105 => 47,  101 => 46,  91 => 43,  85 => 40,  79 => 38,  76 => 37,  59 => 36,  52 => 32,  48 => 31,  44 => 30,  39 => 27,);
    }

    public function getSourceContext()
    {
        return new Source("", "modules/module_filter/templates/system-modules-details.html.twig", "/var/www/dailynews/web/modules/module_filter/templates/system-modules-details.html.twig");
    }
